...
+ function($) {
  ...
  $.prompt = function(text, title, onOK, onCancel, input) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">'+(config.text || '')+'</p><input type="text" placeholder="请输入公司名" class="weui_input weui-prompt-input" id="weui-prompt-input" value="' + (config.input || '') + '" />',
      title: config.title,
      autoClose: false,
      buttons: [
      {
  ...
  $.login = function(text, title, onOK, onCancel, username, password) {
    ...
    var modal = $.modal({
      text: '<p class="weui-prompt-text">H5EDU '+(config.text || '')+'</p>' +
